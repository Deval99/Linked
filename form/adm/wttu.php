...
<head>
  ...
  <meta charset='UTF-8'>
  <title>Update Weekly Time Table</title>
  <script src='https://s.codepen.io/assets/libs/modernizr.js' type='text/javascript'></script>
  <link rel='stylesheet' href='temp/css/style.css'>
 </head>
<body> <?php session_start(); if(isset($_SESSION['utype'])){ if($_SESSION['utype'] == 'admin'){ ?>
  <form style='margin-top:20px; margin-bottom:0px;' action='../../p/adm/wttu.php' method='POST'>
  <h1>Update Weekly Time Table (For 1 Row)</h1><br/>
  <h4><i>*Please Fill All Details Carefully ! <br> NOTE - It Is Recommended To Open Weekly_Time_Table Table View In Another Tab !</i></h4>
<!--dept,sem,index,mon...-->
